...
<body>
    ...
    <div class="main-container">
        ...
        <form action="{{ route('dashboard.admin.kategori-klinis.store') }}" method="POST" class="form-layout">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_kategori_klinis" id="nama_kategori_klinis"
                    class="form-control" value="{{ old('nama_kategori_klinis') }}"
            ...
            <div class="form-actions">
                <a href="{{ route('dashboard.admin.kategori-klinis.index') }}" class="btn btn-secondary">
