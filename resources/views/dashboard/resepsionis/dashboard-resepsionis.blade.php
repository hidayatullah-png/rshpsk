        ...
        <div class="nav-right">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="{{ url('dashboard/resepsionis/registrasi-pemilik/create') }}">Registrasi Pemilik</a>
                    <a href="{{ url('dashboard/resepsionis/registrasi-pet/create') }}">Registrasi Pet</a>
                    <a href="{{ url('dashboard/resepsionis/temu-dokter/create') }}">Temu Dokter</a>
                </div>
            </div>
