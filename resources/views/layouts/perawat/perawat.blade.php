...
<body>
    ...
    <nav class="nav-utama">
        ...
        <div class="nav-right">
            {{-- Dropdown Data Master Perawat --}}
            <div class="dropdown">
                <a href="javascript:void(0)" class="dropdown-toggle">
                    Menu Perawat <i class="fas fa-chevron-down" style="font-size: 0.7em;"></i>
                </a>
                <div class="dropdown-menu">
                    <a href="{{ url('dashboard/perawat/rekam-medis') }}">
                        <i class="fas fa-file-medical"></i> Rekam Medis
                    </a>
                    <a href="{{ url('dashboard/perawat/pasien') }}">
                        <i class="fas fa-user-injured"></i> Data Pasien
                    </a>
                    <a href="{{ url('dashboard/perawat/profil') }}">
